...
params_3d_test_sample8_64_64_64_2 = {'dev': "cpu",
                                     'use_simulation_sample': True,
                                     'simulation_probe_cts': 1.0E7, #used only when use_simulation_sample is False   
                                     'probe_att': True,
                                     'std_path': None, #used only when use_simulation_sample is False    
                                     'f_std': None, #used only when use_simulation_sample is False  
                                     'fitting_method':None, # set to 'XRF_fits' , 'XRF_roi' or 'XRF_roi_plus',  #used only when use_simulation_sample is False  
                                     'std_element_lines_roi': None,  #used only when use_simulation_sample is False   
                                     'density_std_elements': None,  # unit in g/cm^2,  #used only when use_simulation_sample is False  
                                     'selfAb': True,
                                     'recon_path':"./data/sample8_size_64_pad/nElements_2",
                                     'f_recon_grid': "grid_concentration",
                                     'f_reconstructed_XRF_signal':"test8_xrf",
                                     'f_reconstructed_XRT_signal':"test8_xrt",
                                     'theta_st': 0, #used only when generate_simulation_sample is True
                                     'theta_end': 360, #used only when generate_simulation_sample is True
                                     'n_theta': 200, #used only when generate_simulation_sample is True  
                                     'cont_from_last_theta': False,
...
params = params_3d_test_sample8_64_64_64_2
