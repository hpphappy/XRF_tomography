...
params_3d_44_44_20_xtal1_roi_plus = {'recon_idx': 0,
                              'f_recon_parameters': 'recon_parameters.txt',  # The txt file that will save the reconstruction parameters
                              'dev': dev,
                              'selfAb': True,
                              'cont_from_check_point': False,
                              ...
                              'init_const': 0.5,
                              'ini_rand_amp': 0.1,
                              'recon_path': './data/Xtal1_align1_adjusted1_ds4_recon/b_1E-4_woSelfAb',
                              'f_initial_guess': 'initialized_grid_concentration',
                              'f_recon_grid': 'grid_concentration',
                              ...
                              'n_epoch': 40,
                              'minibatch_size': 44,
                              'b': 1.0E-4,  # the regulizer coefficient of the XRT loss
                              'lr': 1.0E-3,                          
                              ...
                              'P_folder': 'data/P_array/sample_44_44_20/detSize_2.4_detSpacing_1.2_dpts_5',              
...
params_3d_88_88_40_xtal1_roi_plus = {'recon_idx': 0,
                              ...
                              'init_const': 0.5,
                              'ini_rand_amp': 0.1,
                              'recon_path': './data/Xtal1_align1_adjusted1_ds2_recon_woSelfAb',
                              'f_initial_guess': 'initialized_grid_concentration',
                              'f_recon_grid': 'grid_concentration',
                              ...
                              'det_from_sample_cm': 3.0, # The estimated spacing between the sample and the detector
                              'det_ds_spacing_cm': 2.4/2.0, # Set this value to the value of det_size_cm divided by a number
                              'P_folder': 'data/P_array/sample_88_88_40/detSize_2.4_detSpacing_1.2_dpts_5',              
                              'f_P': 'Intersecting_Length_88_88_40',  # The output file name has det_size_cm and det_ds_spacing_cm and det_from_sample_cm 
                              'fl_K': fl["K"], # doesn't need to change 
                              'fl_L': fl["L"], # doesn't need to change                    
                              'fl_M': fl["M"]  # doesn't need to change
                             }
